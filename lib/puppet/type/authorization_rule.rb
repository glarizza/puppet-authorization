Puppet::Type.newtype(:authorization_rule) do

  desc "Manage rules in the Mac OS X authorization database. See the
  ...
  newparam(:name, :namevar => true) do
    desc "The name of the rule to be managed.  Corresponds to `key` in
